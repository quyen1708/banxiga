...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th8 21, 2020 lúc 08:14 PM
...
CREATE TABLE `order_list` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '0: Chua xy ly; 1: dang xu ly; 2:da xu ly',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(50, 15, 'Thuốc lá cuốn tay Drum Bright Blue', '<p>Th&ocirc;ng tin sản phẩm:<br />\r\n- T&ecirc;n SP: Drum Bright Blue<br />\r\n- M&atilde; SP: SP-005<br />\r\n- Trọng lượng: 50g ( cuốn được tầm 80 - 100 điếu )<br />\r\n- Hương vị: Sợi nguy&ecirc;n chất&nbsp;<br />\r\n- Thương hi&ecirc;̣u: Drum<br />\r\n- Sản xuất: H&agrave; Lan<br />\r\n- Thuốc l&aacute; cuốn tay Drum Bright Blue một hương vị thỏa m&atilde;n đến từ một sự kết hợp độc đ&aacute;o của thuốc l&aacute; chất lượng: Bright virginia, burley vị hấp dẫn v&agrave; đậm kentucky</p>', 120000, 100, 1, 0, '2020-08-11 00:34:24', '2020-08-11 00:34:24', 0),
...
(18, 20, 'uploads/product/1597131794_5f324c12046ea.jpg', 1, '2020-08-11 00:43:14', '2020-08-11 00:43:14'),
(19, 20, 'uploads/product/1597131804_5f324c1c01bc1.jpg', 1, '2020-08-11 00:43:24', '2020-08-11 00:43:24'),
